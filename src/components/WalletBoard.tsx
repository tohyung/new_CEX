...
import { Wallet, Plus, Shield, ArrowUpRight, TrendingUp, TrendingDown, Search, Maximize2, X } from 'lucide-react';
      ...
      <div className="flex items-center justify-between px-3 py-2 bg-white/[0.02] border-b border-white/[0.08] select-none shrink-0">
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-2 py-0.5 rounded-md bg-white/10 hover:bg-white/20 text-white font-medium text-[10px] border border-white/10 transition-colors active:scale-95"
          >
